...
class CSI_Tester_Robot:
    ...
    def callback(self, msg):
	    ...
	    print("Waiting for new request")
            #close(self.home_dir+'/Harvard_CS286/cs286_mini_hack_2/rx_displacement_odom.csv')
            #close(self.home_dir+'/Harvard_CS286/cs286_mini_hack_2/rx_displacement_t265.csv')


if __name__ == '__main__':
    try:
        CSI_Tester_Robot('odom','cmd_vel','linear')
